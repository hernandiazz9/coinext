      ...
      <div className='container-fluid '>
        <div className=' container mx-auto inner-sec-shop px-lg-4 px-3'>
          ...
          <div className='container text-center mt-5'>
            <Link
              className='btn btn-sm my-hover text-black animated-button gibson-three mt-4'
              href='/productos'
            >
              Más Productos
            </Link>
            ...
            <div className='row'>
              <div className='col-lg-4 bottom-sub-grid text-center'>
                ...
                <p>
                  <Link
                    href='/productos'
                    className='btn btn-sm my-hover animated-button gibson-three mt-4'
                  >
                    Productos
                  </Link>
                </p>
              ...
              <div className='col-lg-4 bottom-sub-grid text-center'>
                ...
                <p>
                  <Link
                    href='/productos'
                    className='btn my-hover btn-sm animated-button gibson-three mt-4'
                  >
                    Productos
                  </Link>
                </p>
